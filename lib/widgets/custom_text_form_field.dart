...
class CustomTextFormField extends StatelessWidget {
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodySmallGray90001,
        prefixIcon: prefix,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get outlineBlueGrayE => OutlineInputBorder(
  ...
  static OutlineInputBorder get outlineIndigoA => OutlineInputBorder(
        borderRadius: BorderRadius.circular(16.h),
        borderSide: BorderSide(
