...
class EventDetailsTwoScreen extends StatelessWidget {
  const EventDetailsTwoScreen({Key? key})
      : super(
          key: key,
        );
  ...
  /// Section Widget
  Widget _buildEventDetailsTwo(BuildContext context) {
    return SizedBox(
      height: 51.v,
      width: 327.h,
      child: Stack(
