import '../event_details_twentyone_screen/widgets/banklogo_item_widget.dart';
...
class EventDetailsTwentyoneScreen extends StatelessWidget {
  EventDetailsTwentyoneScreen({Key? key})
      : super(
          key: key,
        );
