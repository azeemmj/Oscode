...
class VerificationScreen extends StatelessWidget {
                        ...
                        child: Stack(
                          ...
                          children: [
                            Opacity(
                              opacity: 0.5,
                              child: CustomImageView(
                                imagePath: ImageConstant.imgEllipse702,
                                height: 362.v,
                                width: 66.h,
                            ...
                            _buildKeyboardsLightNumeric(context),
                          ],
                        ),
                      ),
                    ],
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: 274.h,
                  child: Text(
                    "We’ve send you the verification code on phone number: XXXX",
                    maxLines: 2,
  ...
  /// Section Widget
  Widget _buildKeyboardsLightNumeric(BuildContext context) {
    return Align(
