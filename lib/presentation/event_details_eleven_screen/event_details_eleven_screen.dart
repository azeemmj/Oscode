import '../event_details_eleven_screen/widgets/chipview_item_widget.dart';
import '../event_details_eleven_screen/widgets/frame6_item_widget.dart';
...
class EventDetailsElevenScreen extends StatelessWidget {
  const EventDetailsElevenScreen({Key? key})
      : super(
          key: key,
        );
                  ...
                  Opacity(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style:
                            CustomTextStyles.titleMediumBluegray40001.copyWith(
                          height: 1.33,
                        ),
                      ),
                    ),
  ...
  Widget _buildChipView(BuildContext context) {
    return Wrap(
      runSpacing: 10.v,
      spacing: 10.h,
      children: List<Widget>.generate(13, (index) => ChipviewItemWidget()),
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          runSpacing: 16.v,
          spacing: 16.h,
          children: List<Widget>.generate(8, (index) => Frame6ItemWidget()),
        ),
      ],
    );
  }
