...
class EventDetailsFiveScreen extends StatelessWidget {
  const EventDetailsFiveScreen({Key? key})
      : super(
          key: key,
        );
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              _buildEventDetailsFive(context),
  ...
  /// Section Widget
  Widget _buildEventDetailsFive(BuildContext context) {
    return SizedBox(
      height: 51.v,
      width: 327.h,
      child: Stack(
