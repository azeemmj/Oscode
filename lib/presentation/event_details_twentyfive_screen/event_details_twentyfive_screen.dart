...
class EventDetailsTwentyfiveScreen extends StatelessWidget {
  const EventDetailsTwentyfiveScreen({Key? key})
      : super(
          key: key,
        );
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              _buildEventDetailsTwentyNine(context),
              SizedBox(height: 17.v),
              _buildWalletRow(context),
              SizedBox(height: 5.v),
              _buildUpiIconOneRow(context),
              SizedBox(height: 5.v),
              _buildNetBankingRow(context),
              SizedBox(height: 5.v),
              _buildCreditDebitRow(context),
              Spacer(),
              SizedBox(height: 7.v),
              Align(
  ...
  /// Section Widget
  Widget _buildEventDetailsTwentyNine(BuildContext context) {
    return SizedBox(
      height: 51.v,
      width: 327.h,
      child: Stack(
  ...
  /// Section Widget
  Widget _buildUpiIconOneRow(BuildContext context) {
    return Container(
      width: double.maxFinite,
      padding: EdgeInsets.symmetric(
        horizontal: 20.h,
  ...
  /// Section Widget
  Widget _buildNetBankingRow(BuildContext context) {
    return Container(
      width: double.maxFinite,
      padding: EdgeInsets.symmetric(
        horizontal: 20.h,
  ...
  /// Section Widget
  Widget _buildCreditDebitRow(BuildContext context) {
    return Container(
      width: double.maxFinite,
      padding: EdgeInsets.symmetric(
        horizontal: 20.h,
