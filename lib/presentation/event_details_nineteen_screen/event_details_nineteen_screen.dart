...
class EventDetailsNineteenScreen extends StatelessWidget {
  const EventDetailsNineteenScreen({Key? key})
      : super(
          key: key,
        );
          ...
          child: Column(
            children: [
                  ...
                  children: [
                    Opacity(
                      ...
                      child: CustomImageView(
                        imagePath: ImageConstant.imgStar1180x180,
                        height: 180.adaptSize,
                        width: 180.adaptSize,
              ...
              SizedBox(
                width: 235.h,
                child: Text(
                  "You have been successfully become mentor you have to wait for 24hrs until admin accept your request",
                  maxLines: 4,
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.center,
